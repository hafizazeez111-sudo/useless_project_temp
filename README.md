<img width="1280" height="640" alt="Who Is More Useless Banner" src="https://github.com/user-attachments/assets/8920b256-2ba8-4988-b824-5351134eb4bd" />
...
```mermaid
graph TD
    Player[🧑‍🚀 Players Capture Face] -->|Webcam Snapshot| Frontend[💻 8-Bit Web Interface]
    Frontend -->|Base64 Image Data| Proxy[🔒 Vercel Serverless Function /api/analyze-face]
    Proxy -->|Secret GEMINI_API_KEY + Prompt| Gemini[🤖 Google Gemini 1.5 Flash Vision AI]
    Gemini -->|Returns Roast & Custom Questions JSON| Proxy
    Proxy -->|Parsed AI Data| Frontend
    Frontend -->|Renders AI Roast & Dynamic Quiz| Quiz[🎮 Retro Quiz Gameplay & Final Verdict]
```
